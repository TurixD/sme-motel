...
- Cada gasto tiene un origen (gastos_extras.afecta_utilidad): si salió del "dinero de la semana" baja la utilidad (afecta_utilidad=1); si salió de un fondo o de "ningún lado" NO baja la utilidad (afecta_utilidad=0). Por eso utilidad = ingresos − SUM(gastos WHERE afecta_utilidad=1). Los fondos (Reserva, CFE, etc.) son ahorros aparte y opcionales (gastos_extras.fondo_descontado_id), se crean/borran desde la pantalla Fondos.
